...
export default {
  ...
  color_text_base_inverse: '#ffffff', // toast
  ...
  h_spacing_lg: 15,
  // 垂直间距
  v_spacing_xs: 3, // toast
  v_spacing_sm: 6,
  v_spacing_md: 9, // toast
  v_spacing_lg: 15, // toast
  v_spacing_xl: 21,
  // 高度
  // ---
  line_height_base: 1,
